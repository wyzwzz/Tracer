...
class Timer
{
  public:
    ...
    void print_duration(std::string msg = "", std::string unit = "ms")
    {
        if (unit == "ms")
            LOG_INFO("{} duration: {}",msg,d.ms().fmt());
        else if (unit == "us")
            LOG_INFO("{} duration: {}",msg,d.us().fmt());
        else if (unit == "ns")
            LOG_INFO("{} duration: {}",msg,d.ns().fmt());
        else if (unit == "s")
            LOG_INFO("{} duration: {}",msg,d.s().fmt());
        else
